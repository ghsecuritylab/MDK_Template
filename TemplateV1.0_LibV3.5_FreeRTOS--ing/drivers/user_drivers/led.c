...
{
    GPIOD, GPIO_Pin_2, GPIO_Speed_2MHz, GPIO_Mode_Out_PP,
    GPIOD, GPIO_Pin_3, GPIO_Speed_2MHz, GPIO_Mode_Out_PP,
    GPIOD, GPIO_Pin_4, GPIO_Speed_2MHz, GPIO_Mode_Out_PP,
    GPIOD, GPIO_Pin_7, GPIO_Speed_2MHz, GPIO_Mode_Out_PP,
};
