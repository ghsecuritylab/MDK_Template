...
/* 1：使能空闲钩子，则空闲钩子函数需要由用户实现   
   0：忽略空闲钩子 */
#define configUSE_IDLE_HOOK			0
/* 1：使能时间片钩子，则时间片钩子函数需要由用户实现 见main.c  
   0：忽略时间片钩子 */
#define configUSE_TICK_HOOK			0
/* cpu时钟频率，用于正确配置系统节拍中断周期 */
...
/* 配置FreeRTOS内核总共可用的堆大小 */
#define configTOTAL_HEAP_SIZE		( ( size_t ) ( 30 * 1024 ) )
/* 定义的字符串长度包含字符串结束符 '\0' */
#define configMAX_TASK_NAME_LEN		( 16 )
/* 启动可视化跟踪调试 会激活附加的结构体成员和函数 */
#define configUSE_TRACE_FACILITY	1
/* 1( 0 )：portTickType为16( 32 )位无符号整型*/
#define configUSE_16_BIT_TICKS		0
#define configIDLE_SHOULD_YIELD		1

/* Co-routine definitions. */
/* 据说基本可以放弃使用FreeRTOS的协程 */ 
...
/* 栈溢出检查 0 1 2.. 不为0时用户需提供
vApplicationStackOverflowHook函数的实现 */
#define configCHECK_FOR_STACK_OVERFLOW	2
#define configUSE_RECURSIVE_MUTEXES		1
#define configQUEUE_REGISTRY_SIZE		0
/* 1：运行时间统计 此时需要本文件后面的相关语句取消注释 */
...
/* 如果 #define configGENERATE_RUN_TIME_STATS	1
    则使用以下语句，用户需要提供一个基准时钟函数（利用定时器即可）
*/
